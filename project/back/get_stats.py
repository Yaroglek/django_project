...
def get_geography_page_content(df: pd.DataFrame):
    ...
    print(f"Доля вакансий по городам: {get_top_cities_by_vacancies(vacancies_by_area)}")
    ...
    print(f"Доля вакансий по городам для выбранной профессии: {get_top_cities_by_vacancies(prof_vacancies_by_area)}")
